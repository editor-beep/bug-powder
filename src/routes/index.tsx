  ...
  head: () => ({
    meta: [
      { title: "Interzone Feed — Step inside." },
      {
        name: "description",
        content:
          "A surreal, escalating hallucination simulator. Burroughs-coded. Free your habits into the Interzone.",
      },
    ],
  }),
});
    ...
    <div className="iz-scanlines iz-noise min-h-dvh w-full max-w-full overflow-x-hidden flex flex-col items-center justify-center px-4 py-16 text-center">
      <div className="w-full max-w-2xl iz-drift-in">
        ...
        <div className="space-y-4 text-iz-bone/85 text-base sm:text-lg font-mono leading-relaxed mb-12">
          <p className="iz-typewriter-cursor">Welcome, citizen. Your file has been pre-opened.</p>
          <p className="text-muted-foreground italic text-sm">
            What begins as a habit tracker descends. The Mugwumps will see you now. Dependence is
            mandatory. Surveillance is for your comfort.
          </p>
        </div>
        ...
        <motion.div whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }}>
          <Link
            to="/feed"
            className="inline-block max-w-full px-6 sm:px-8 py-4 bg-iz-blood/20 border-2 border-iz-blood text-iz-bone font-display text-lg sm:text-xl uppercase tracking-[0.2em] sm:tracking-widest hover:bg-iz-blood/40 hover:shadow-[0_0_30px_rgba(130,20,37,0.6)] transition-all"
          >
